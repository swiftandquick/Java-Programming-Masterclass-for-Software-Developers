package s15p280_More_on_Deadlocks;
    ...
    */
    ...
    static class PolitePerson {
        ...
        public synchronized void sayHello(PolitePerson person) {
            /* First %s is replaced by name, second %s is replaced by person.getName().  %n creates a new line.
            * If object is jane, this.name should be "Jane", and person.getName() should be "John".  */
            System.out.format("%s: %s" + " has said hello to me!  %n", this.name, person.getName());
            /* Call the sayHelloBack() method.  If this is jane, then person is john, and use john to call the
            * sayHelloBack method, with jane as the argument.  */
