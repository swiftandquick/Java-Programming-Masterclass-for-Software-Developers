package s8ce44_Mobile_Phone_b;

import s8p108_Array_List_Challenge.Contact;
import s8p108_Array_List_Challenge.MobilePhone;
...
public class Main {
    ...
    private static s8p108_Array_List_Challenge.MobilePhone mobilePhone = new MobilePhone("0039-330-4404");
    ...
    private static void addNewContact() {
        ...
        s8p108_Array_List_Challenge.Contact newContact = s8p108_Array_List_Challenge.Contact.createContact(name, phone);
    ...
    private static void updateContact() {
        ...
        s8p108_Array_List_Challenge.Contact existingContactRecord = mobilePhone.queryContact(name);
        if (existingContactRecord == null) {
            ...
            s8p108_Array_List_Challenge.Contact newContact = s8p108_Array_List_Challenge.Contact.createContact(newName, newNumber);
